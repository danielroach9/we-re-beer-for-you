				 	  ...
				 	  if(data){
				 	  	...
				 	  	console.log($beers);
					  		$.each($beers,function(key,value){
					  			$("#results").append("<div class='col s3'><div class='card hoverable small beer-card'><div class='card-content center-align'><a href='beer.php?id="+value.id+"'><span class='card-title'>"+value.name+"</span></a></div></div></div>");
					  		});
